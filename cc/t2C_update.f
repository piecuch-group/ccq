       subroutine t2c_update(n0,n1,n2,n3,k1,k2,k3,k4,lvl,lvl1,lvlq,shift
...
c
      ...
      if(lvl.eq.'acpq')then
       factor=0.500*12.7279
       call sum3412(n0,n2,n0,n2,n0,n2,n0,n2,x5,s61,factor)
       factor=0
      else
       factor=0.500*diag5
...
!a!       deallocate(z15)
c
      if(lvlq.eq.'ccsdt'.or.lvlq.eq.'4cc')then
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
