...
C
     ...
     & (/N0-N0,M2-N1,N1-N1,N1-N1,N0-N0,M1-M1/),'412356',t3A,F2)
       ...
       deallocate(F2)
C
       call sum_stripe(4,shape(X21),size(X21),'2341',2.000,
     & X21,S85)
       deallocate(S85)
C
...
C
       ...
       X22=0.0d0
       call sum_stripe(4,shape(X22),size(X22),'2341',1.000,
     & X22,S93)
       deallocate(S93)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
     ...
     & (/N0-N0,M2-N1,N1-N1,N1-N1,N0-N0,M1-M1/),'412356',t3A,F2)
       ...
       deallocate(F2)
C
       call sum_stripe(4,shape(X22),size(X22),'2341',2.000,
     & X22,S97)
       deallocate(S97)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
...
C
     ...
     & (/N0-N0,N1-N1,N1-N1,N1-N1/),'2341',S101,D1)
       allocate(F2(N0+1:M1,N1+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/N0-N0,N1-N1,N1-N1,N1-N1,N0-N0,M1-M1/),'412356',t3A,F2)
...
C
     ...
     & (/M1-M1,N1-N1,N1-N1,N1-N1/),'2341',S103,D1)
       allocate(F2(M1+1:N1,N1+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/M1-N0,N1-N1,N1-N1,N1-N1,N0-N0,M1-M1/),'512346',t3A,F2)
...
C
     ...
     & (/M1-M1,N0-N0,M2-M2,M1-M1/),'2341',S109,D1)
...
C
     ...
     & (/N0-N0,M1-M1,M2-M2,M1-M1/),'2341',S111,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1))
...
C
     ...
     & (/M1-M1,M1-M1,M2-M2,M1-M1/),'2341',S113,D1)
...
C
     ...
     & (/M1-M1,N0-N0,N2-N2,M1-M1/),'2341',S115,D1)
...
C
     ...
     & (/N0-N0,M1-M1,N2-N2,M1-M1/),'2341',S117,D1)
...
C
     ...
     & (/M1-M1,M1-M1,N2-N2,M1-M1/),'2341',S119,D1)
...
C
     ...
     & (/N0-N0,N0-N0,M2-M2,N0-N0/),'2341',S121,D1)
       allocate(F2(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N1))
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
...
C
     ...
     & (/M1-M1,N0-N0,M2-M2,N0-N0/),'2341',S123,D1)
...
C
     ...
     & (/N0-N0,M1-M1,M2-M2,N0-N0/),'2341',S125,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N1))
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
...
C
     ...
     & (/M1-M1,M1-M1,M2-M2,N0-N0/),'2341',S127,D1)
...
C
     ...
     & (/N0-N0,N0-N0,N2-N2,N0-N0/),'2341',S129,D1)
...
C
     ...
     & (/M1-M1,N0-N0,N2-N2,N0-N0/),'2341',S131,D1)
...
C
     ...
     & (/N0-N0,M1-M1,N2-N2,N0-N0/),'2341',S133,D1)
...
C
     ...
     & (/M1-M1,M1-M1,N2-N2,N0-N0/),'2341',S135,D1)
...
C
     ...
     & (/N0-N0,N2-N2,N1-N1,N1-N1/),'2341',S149,D1)
...
C
     ...
     & (/M1-M1,N2-N2,N1-N1,N1-N1/),'2341',S151,D1)
...
C
     ...
     & (/N0-N0,N2-N2,N1-N1,N1-N1/),'2341',S165,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/N0-N0,N2-N2,N1-N1,N1-N1,N0-N0,M1-M1/),'412356',t3B1,F2)
...
C
     ...
     & (/M1-M1,N2-N2,N1-N1,N1-N1/),'2341',S167,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,N2-N2,N1-N1,N1-N1,N0-N0,M1-M1/),'412356',t3B1,F2)
