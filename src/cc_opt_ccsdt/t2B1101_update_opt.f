...
C
     ...
     & (/N0-N0,M2-N1,N1-N1,N2-N2,M1-N0,M1-M1/),'523146',t3B1,F2)
       ...
       deallocate(F2)
C
       call sum_stripe(4,shape(X39),size(X39),'2341',2.000,
     & X39,S77)
       deallocate(S77)
C
...
C
     ...
     & (/N0-N0,N0-N0,M2-M2,M1-M1/),'2341',S89,D1)
       allocate(F2(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2))
...
C
     ...
     & (/M1-M1,N0-N0,M2-M2,M1-M1/),'2341',S91,D1)
...
C
     ...
     & (/N0-N0,M1-M1,M2-M2,M1-M1/),'2341',S93,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2))
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
...
C
     ...
     & (/M1-M1,M1-M1,M2-M2,M1-M1/),'2341',S95,D1)
...
C
     ...
     & (/N0-N0,N0-N0,N2-N2,M1-M1/),'2341',S97,D1)
...
C
     ...
     & (/M1-M1,N0-N0,N2-N2,M1-M1/),'2341',S99,D1)
...
C
     ...
     & (/N0-N0,M1-M1,N2-N2,M1-M1/),'2341',S101,D1)
...
C
     ...
     & (/M1-M1,M1-M1,N2-N2,M1-M1/),'2341',S103,D1)
