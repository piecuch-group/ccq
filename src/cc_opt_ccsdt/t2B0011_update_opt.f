...
C
     ...
     & (/M1-M1,N1-N1,N1-N1,N1-N1/),'2341',S51,D1)
...
C
     ...
     & (/M1-M1,N0-N0,M2-M2,N0-N0/),'2341',S55,D1)
...
C
     ...
     & (/N0-N0,M1-M1,M2-M2,N0-N0/),'2341',S57,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1))
...
C
     ...
     & (/M1-M1,M1-M1,M2-M2,N0-N0/),'2341',S59,D1)
...
C
     ...
     & (/M1-M1,N0-N0,N2-N2,N0-N0/),'2341',S61,D1)
...
C
     ...
     & (/N0-N0,M1-M1,N2-N2,N0-N0/),'2341',S63,D1)
...
C
     ...
     & (/M1-M1,M1-M1,N2-N2,N0-N0/),'2341',S65,D1)
...
C
     ...
     & (/M1-M1,N2-N2,N1-N1,N1-N1/),'2341',S73,D1)
...
C
     ...
     & (/M1-M1,M2-M2,M2-M2,N1-N1,N0-N0,N0-N0/),'512346',t3C3,F2)
       ...
       deallocate(F2)
C
       call sum_stripe(4,shape(X22),size(X22),'2341',-0.500,
     & X22,S107)
       deallocate(S107)
C
