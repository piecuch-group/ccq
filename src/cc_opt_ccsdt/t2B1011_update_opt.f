...
C
     ...
     & (/N0-N0,M2-N1,N1-N1,N2-N2,N0-N0,M1-M1/),'523146',t3B1,F2)
       ...
       deallocate(F2)
C
       call sum_stripe(4,shape(X31),size(X31),'2341',2.000,
     & X31,S73)
       deallocate(S73)
C
...
C
     ...
     & (/M1-M1,N0-N0,N2-N2,M1-M1/),'2341',S91,D1)
...
C
     ...
     & (/N0-N0,M1-M1,N2-N2,M1-M1/),'2341',S93,D1)
...
C
     ...
     & (/M1-M1,M1-M1,N2-N2,M1-M1/),'2341',S95,D1)
...
C
       ...
       X32=0.0d0
       call sum_stripe(4,shape(X32),size(X32),'2341',1.000,
     & X32,S133)
       deallocate(S133)
C
...
C
     ...
     & (/N0-N0,M2-M2,M2-M2,N1-N1,N0-N0,M1-M1/),'412356',t3C2,F2)
       ...
       deallocate(F2)
C
       call sum_stripe(4,shape(X32),size(X32),'2341',-0.500,
     & X32,S165)
       deallocate(S165)
C
