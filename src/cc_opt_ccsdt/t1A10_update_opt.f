...
C
     ...
     & (/N0-N0,N0-N0,M2-N1,N1-N1,M2-N1,M1-M1/),'451326',t3A,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,M2-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/N0-N0,M1-N0,M2-N1,N1-N1,M2-N1,M1-M1/),'451326',t3A,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,M2-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/M1-N0,M1-N0,M2-N1,N1-N1,M2-N1,M1-M1/),'451326',t3A,F2)
...
C
     ...
     & size(D1),(/N0-N0,N0-N0,N1-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/N0-N0,N0-N0,N1-N1,N1-N1,M2-N1,M1-M1/),'452316',t3A,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,N1-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/N0-N0,M1-N0,N1-N1,N1-N1,M2-N1,M1-M1/),'452316',t3A,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,N1-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3A),size(t3A),shape(F2),size(F2),
     & (/M1-N0,M1-N0,N1-N1,N1-N1,M2-N1,M1-M1/),'452316',t3A,F2)
...
C
     ...
     & (/N0-N0,N0-N0,M2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/M1-N0,N0-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,N0-N0,M2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:M2,M2+1:N3,M1+1:N1))
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/N0-N0,M1-N0,M2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,M1-N0,M2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/N0-N0,N0-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/N0-N0,N0-N0,N2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/M1-N0,N0-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,N0-N0,N2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/N0-N0,M1-N0,N2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,M1-N0,N2-N2,N1-N1,M2-N1,M1-M1/),'451326',t3B1,F2)
