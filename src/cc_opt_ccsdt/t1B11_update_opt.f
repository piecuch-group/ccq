...
C
     ...
     & (/N0-N0,N0-N0,M2-M2,M2-M2,N2-N2,M1-M1/),'562314',t3B2,F2)
...
C
     ...
     & (/N0-N0,M1-M1,M2-M2,M2-M2,N2-N2,M1-N0/),'562314',t3B3,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,M2-N1,M2-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B3),size(t3B3),shape(F2),size(F2),
     & (/M1-N0,M1-M1,M2-M2,M2-M2,N2-N2,M1-N0/),'562314',t3B3,F2)
...
C
     ...
     & (/N0-N0,N0-N0,M2-N1,N1-N1,N2-N2,M1-M1/),'562314',t3B4,F2)
...
C
     ...
     & (/N0-N0,M1-M1,M2-N1,N1-N1,N2-N2,M1-N0/),'562314',t3B1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,M2-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,M1-M1,M2-N1,N1-N1,N2-N2,M1-N0/),'562314',t3B1,F2)
...
C
     ...
     & size(D1),(/N0-N0,N0-N0,N1-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B4),size(t3B4),shape(F2),size(F2),
     & (/N0-N0,N0-N0,N1-N1,N1-N1,N2-N2,M1-M1/),'562314',t3B4,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,N1-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/N0-N0,M1-M1,N1-N1,N1-N1,N2-N2,M1-N0/),'562314',t3B1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,N1-N1,N1-N1/),'3412',VAHHPP,D1)
       ...
       call reorder_shift(6,shape(t3B1),size(t3B1),shape(F2),size(F2),
     & (/M1-N0,M1-M1,N1-N1,N1-N1,N2-N2,M1-N0/),'562314',t3B1,F2)
...
C
     ...
     & (/N0-N0,N0-N0,M2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,N0-N0,M2-N2,M2-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,N0-N0,M2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,M2-N2,M2-N1/),'3412',VBHHPP,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,M1-N0,M2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,M2-N2,M2-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,M1-N0,M2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,N0-N0,N2-N2,M2-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,N0-N0,N2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,N0-N0,N2-N2,M2-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,N0-N0,N2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,N2-N2,M2-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,M1-N0,N2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,N2-N2,M2-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,M1-N0,N2-N2,M2-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,N0-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       allocate(F2(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:M2,N2+1:M2,M1+1:N2))
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,N0-N0,M2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,N0-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,N0-N0,M2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:M2,N2+1:M2,M1+1:N2))
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,M1-N0,M2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,M2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,M1-N0,M2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,N0-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,N0-N0,N2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,N0-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,N0-N0,N2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/N0-N0,M1-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/N0-N0,M1-N0,N2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
...
C
     ...
     & size(D1),(/M1-N0,M1-N0,N2-N2,N1-N1/),'3412',VBHHPP,D1)
       ...
       call reorder_shift(6,shape(t3C1),size(t3C1),shape(F2),size(F2),
     & (/M1-N0,M1-N0,N2-N2,N1-N1,N2-N2,M1-M1/),'461325',t3C1,F2)
