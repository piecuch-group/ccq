...
C
       call
     & sum2134(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U6,-0.500)
       deallocate(U6)
       deallocate(Q1)
C
...
C
       call
     & sum4123(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U7,-0.500)
       deallocate(U7)
       deallocate(Q2)
C
...
C
       call
     & sum3124(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U19,-1.000)
       deallocate(U19)
       deallocate(Q4)
C
...
C
       call
     & sum2134(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U20,-1.000)
       deallocate(U20)
       deallocate(Q5)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
...
C
       call
     & sum4123(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U21,-1.000)
       deallocate(U21)
       deallocate(Q6)
C
...
C
       call
     & sum3124(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U24,-0.500)
       deallocate(U24)
       deallocate(Q8)
C
...
C
       call
     & sum1342(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U9,1.000)
       deallocate(U9)
C
...
C
       call
     & sum1243(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U10,-1.000)
       deallocate(U10)
C
...
C
       call
     & sum2341(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U11,1.000)
       deallocate(U11)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N0+1:N1))
...
C
       call
     & sum1324(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U12,1.000)
       deallocate(U12)
C
...
C
       call
     & sum2314(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U14,-1.000)
       deallocate(U14)
C
...
C
       call
     & sum1423(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U15,-1.000)
       deallocate(U15)
C
...
C
       call
     & sum3412(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U16,1.000)
       deallocate(U16)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:N2))
       call reorder1324(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
       call
     & sum2413(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U17,1.000)
       deallocate(U17)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call reorder1324(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
       call
     & sum1324(N2,N3,N1,N3,N0,N2,N0,N1,V2B,U22,1.000)
       deallocate(U22)
C
       end
