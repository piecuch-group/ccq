...
C
       call
     & sum2134(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U4,1.000)
       V2C=V2C-U4
       deallocate(U4)
       deallocate(Q1)
C
...
C
       call
     & sum3124(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U5,-1.000)
       call
     & sum4123(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U5,1.000)
       deallocate(U5)
       deallocate(Q2)
C
...
C
       call
     & sum2134(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U11,0.500)
       V2C=V2C-1.0d0/2*U11
       deallocate(U11)
       deallocate(Q3)
C
...
C
       call
     & sum3124(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U12,-0.500)
       call
     & sum4123(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U12,0.500)
       deallocate(U12)
       deallocate(Q4)
C
...
C
       V2C=V2C+U6
       call
     & sum1243(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U6,-1.000)
       deallocate(U6)
C
...
C
       call
     & sum2341(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U7,1.000)
       call
     & sum1342(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U7,-1.000)
       deallocate(U7)
C
...
C
       call
     & sum2314(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U9,-1.000)
       call
     & sum1324(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U9,1.000)
       call
     & sum2413(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U9,1.000)
       call
     & sum1423(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U9,-1.000)
       deallocate(U9)
C
...
C
       call
     & sum3412(N2,N3,N2,N3,N0,N2,N0,N2,V2C,U10,0.500)
       deallocate(U10)
C
       end
