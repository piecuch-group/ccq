subroutine t3a_update(n0, n1, n2, n3, k1, k2, k3, k4, lvl_q, shift, v3a, &
   ...
   if (lvl_q) then
      ...
      do i = n0 + 1, n1 - 2
         do j = i + 1, n1 - 1
         do k = j + 1, n1                     !ilias: if no quadruples comment out the following 14 lines
            if (indocc(k, j, i) .eq. 1) cycle
            !$omp parallel default(none), &
   ...
   if (lvl_q) then
      ...
      do i = n0 + 1, n1 - 2
         do j = i + 1, n1 - 1
         do k = j + 1, n1                     !ilias: if no quadruples comment out the following 12 lines
            if (indocc(k, j, i) .eq. 1) cycle
            !$omp parallel default(none), &
   ...
   if (t2diag3 .ne. 0) then
      ...
      do i = n0 + 1, n1 - 2
         do j = i + 1, n1 - 1
         do k = j + 1, n1                      !ilias: commented out 29 lines for 3cc
            if (indocc(k, j, i) .eq. 1) cycle
            !$omp parallel default(none), &
