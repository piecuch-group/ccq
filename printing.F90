...
contains
    ...
    subroutine print_calc_params(sys, run, cc)
        ...
        write(io,'(2x,a27,2x,i16)') 'Active occupied orbitals (alpha)', sys%act_occ_a
        write(io,'(2x,a27,2x,i16)') 'Active occupied orbitals (beta)', sys%act_occ_b
        ...
        write(io,'(2x,a27,2x,es16.4/)') 'Shift energy', run%shift
